...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_action.setGeometry(QtCore.QRect(570, 10, 131, 41))
        font = QtGui.QFont()
        ...
        self.btn_arriba.setGeometry(QtCore.QRect(700, 60, 131, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.btn_izquierda.setGeometry(QtCore.QRect(560, 110, 131, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.btn_abajo.setGeometry(QtCore.QRect(700, 160, 131, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.btn_derecha.setGeometry(QtCore.QRect(840, 110, 131, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.btn_centro.setGeometry(QtCore.QRect(700, 110, 131, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
