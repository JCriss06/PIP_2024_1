...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        # Área de los Signals
        self.combos_mascotas = {  # ejemplos para el equipo
            1: ['hamster', 'comer', 5, 'a+', ''],
            2: ['gato', 'correr', 8, 'b+', ''],
            3: ['cuyo', 'jugar', 9, 'c+', ''],
            4: ['perro', 'ladrar', 1, 'd+', ''],
        ...
        self.combos_mascotas.addItem('hamster',1)
        self.combos_mascotas.addItem('gato', 2)
        self.combos_mascotas.addItem('cuyo', 3)
        self.combos_mascotas.addItem('perro', 4)
        self.combos_mascotas.addItem('conejo', 5)

        self.combos_mascotas.currentIndexChange.connect(self.cambio)
