...
qtCreatorFile = "P20_InterfazConexionArduino.ui"  # Nombre del archivo aquí.
    ...
    def lecturaArduino(self):
        if not self.arduino is None and self.arduino.isOpen():
            if self.arduino.inWaiting():
                ...
                #print(cadena)
                if cadena != "":
                    #es un txt en lugar de un list widget
                    self.txt_datos.setText("Señal: " + cadena)
                    #self.txt_datos.setCurrentRow(self.datos.count()-1)
