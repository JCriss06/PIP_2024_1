...
qtCreatorFile = "P16_InterfazConexionArduino.ui"  # Nombre del archivo aquí.
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def lecturaArduino(self): #ocupar?
        if not self.arduino is None and self.arduino.isOpen() :
            if self.arduino.inWaiting() and self.btn_actualizar.text() == "Actualizar": #verificar con el sensor
